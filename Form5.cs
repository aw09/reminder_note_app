...
namespace reminder_notes_app
{
    ...
    public partial class EditCategoryNote : Form
    {
        Index parent;
        note_category category;
        public EditCategoryNote(note_category _category, Index _parent)
        {
            InitializeComponent();
            parent = _parent;
            category = _category;
        ...
        private void update_Click(object sender, EventArgs e)
        {
            ...
            var editCategory = (from a in contex.note_category
        ...
        private void delete_Click(object sender, EventArgs e)
        {
            ...
            {
                var contex = new db_reminder_appEntities();
                var deleteCategory = (from a in contex.note_category
                                      where a.id == category.id
                                      select a).Single();
                var listNotes = (from a in contex.notes
                ...
                {
                    contex.note_category.Remove(deleteCategory);
                    contex.SaveChanges();
                    parent.DisplayData();
                    this.Close();
                }
